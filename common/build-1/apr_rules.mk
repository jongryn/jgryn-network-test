...
#
apr_builddir=/Applications/MAMP/htdocs/jgryn-network-test/common/build-1
apr_builders=/Applications/MAMP/htdocs/jgryn-network-test/common/build-1
top_builddir=/Applications/MAMP/htdocs/jgryn-network-test/common/build-1
...
#
CFLAGS=-I/Applications/MAMP/htdocs/jgryn-network-test/common/include -arch x86_64
CPPFLAGS=-DAI_ADDRCONFIG=0 -I/bitnami/mamp72stack-osx-x64/output/sqlite/include -I/Applications/MAMP/htdocs/jgryn-network-test/common/include -I/Applications/MAMP/htdocs/jgryn-network-test/common/include/sasl -I/Applications/MAMP/htdocs/jgryn-network-test/common/include -arch x86_64
LDFLAGS=-L/bitnami/mamp72stack-osx-x64/output/sqlite/lib -L/Applications/MAMP/htdocs/jgryn-network-test/common/lib -arch x86_64 -ldl
LIBS=
DEFS=-DHAVE_CONFIG_H
